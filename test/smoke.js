...
async function main() {
  ...
  // is cross-origin by host (different registrable domain on loopback).
  ...
  try {
    ...
    check("popup state counts tabs and marks active session", Boolean(activeSession?.tabCount >= 1), popupStateJson);
